          ...
          {categories.map((category, index) => {
            ...
            return (
              ...
              >
                ...
                <motion.div 
                  className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-lumina-blue/5 to-lumina-pink/5 rounded-full blur-2xl"
                  animate={isMobile ? {} : {
                ...
                <div className="relative px-6 pt-6 pb-6 md:px-8 md:pt-8 md:pb-6 flex flex-col h-full">
                  ...
                  {/* Button with enhanced mobile interaction */}
                  <motion.div 
                    className="mt-auto"
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.span
                        ...
                        initial={{ x: '-100%' }}
                        animate={isHovered && !isMobile ? { x: '100%' } : {}}
